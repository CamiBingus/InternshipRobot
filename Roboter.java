...
public class Roboter extends Actor
{
    ...
    public int getAnzahl(String name) {
        ...
        {
            melde(""+name+" ist keine g�ltige Bezeichnung f�r einen Gegenstand", true);
        }
        return anz;
    }

    /**
     * Gibt die Restenergie des Roboters zur�ck
    ...
    /**
     * Gibt die x-Koordinate zur�ck, wenn der Roboter einen Schritt nach vorne macht.
     * @return x-Koordinate
     */
    private int xVor() {
    ...
    /**
     * Gibt die y-Koordinate zur�ck, wenn der Roboter einen Schritt nach vorne macht.
     * @return y-Koordinate
     */
            ...
            if (istAufGegenstand("Portal")) {
                if (this instanceof AB1) {
                    if (this.getAnzahl("Schraube")>=2) {
                        ...
                        melde("Du musst erst noch mind. 2  Schrauben einsammeln, um das AB 1 abzuschlie�en.",false);
                    } // end of if-else
    ...
    /**
     * Gibt das erste Gegenstandsobjekt zur�ck, das der angegebenen Art entspricht.
    ...
    private Gegenstand getInventar(String name) {
        if (Gegenstand.istGegenstand(name)) {
            ...
            melde(""+name+" ist kein g�ltiger Gegenstand.",true);
        }
        return null;
    }
    ...
    public void benutze(String name) {
        if (!Gegenstand.istGegenstand(name) && !Wand.istWandtyp(name)) { 
            melde(""+name+" ist keine g�ltige Bezeichnung.",true);
            return;
        } 
        ...
        if (name.equals("Akku") || name.equals("Feuerloescher") || name.equals("Schluessel") || name.equals("Bombe")) {
            if (this.getAnzahl(name)>0) {
                ...
                warne("Du hast gar kein(e) "+name+",\n den/die du benutzen k�nntest.", this);
            }
        }
    }
    ...
    public void aufnehmen ()
    {
        ...
        else warne("Hab keinen Platz f�r weitere Gegenst�nde!",this); 
    }
    ...
    public void gehilfeEinsetzen(Roboter r) {
        if (istVorneFrei() && getWorld().getObjectsAt(xVor(), yVor(), Roboter.class).isEmpty()) {
            ...
            warne("Vor dir ist kein Platz f�r einen Gehilfen!",this);
        }
    }
